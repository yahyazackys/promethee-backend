                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('subkriteria.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Subkriteria" required>
                        </div>
                        <div class="form-group">
                            <label for="bobot">Bobot</label>
                            <input type="number" step="0.01" name="bobot" id="bobot" class="form-control" placeholder="Masukkan Bobot" required>
                        </div>
